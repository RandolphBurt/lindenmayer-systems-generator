...
var LindenmayerSystemLibrary = (function () {
    function LindenmayerSystemLibrary() {
        this.definitions = [
            ...
            new LindenmayerSystemDefinition_1.LindenmayerSystemLibraryDefinition("Crystal", 5, "F+F+F+F", "+", 90, 180, [new LindenmayerSystemDefinition_2.LindenmayerSystemRule("F", "FF+F++F+F")]),
            new LindenmayerSystemDefinition_1.LindenmayerSystemLibraryDefinition("Rings", 5, "F+F+F+F", "+-", 90, 180, [new LindenmayerSystemDefinition_2.LindenmayerSystemRule("F", "FF+F+F+F+F+F-F")])
        ];
    }
